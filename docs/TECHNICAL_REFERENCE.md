...
> nonlinear advection, and the inlet and bay effects that a full model captures. For operational
> forecasting or detailed design use **SLOSH** or **ADCIRC**. Bodine himself notes the method can
