...
**Tier 1 — provisional (class C): fix or supersede first**
...
**Tier 2 — standard (class B) / known residuals at physical inputs**
...
**Tier 3 — class A but validated analytically only (no ACES numeric oracle)**
...
### 1-1 Windspeed Adjustment and Wave Growth  [class A]
...
### 1-2 Beta-Rayleigh Distribution  [class B]
...
### 1-3 Extremal Significant Wave Height  [class A]
...
### 1-4 Constituent Tide Record  [class A]
...
### 1-5 Near-Surface Wind Speeds  [class C]
...
### 1-6 Holland Hurricane Wind Model  [class A]
...
### 2-1 Linear Wave Theory  [class A]
...
### 2-2 Cnoidal Wave Theory  [class A]
...
### 2-3 Fenton Fourier (stream-function)  [class A]
...
### 2-5 Solitary Wave Theory  [class A]
...
### 3-1 Snell's-law Refraction  [class A]
...
### 3-2 Goda Random-Wave Transformation/Breaking  [class C]
...
### 3-4 Wedge Diffraction/Reflection on a Grid  [class A]
...
### 4-1 Breakwater Armor (Hudson)  [class A]
...
### 4-3 Vertical Wall (Wave) Forces  [class A]
...
### 5-1 Irregular Wave Runup on Beaches  [class A]
...
### 5-2 Runup and Overtopping (impermeable)  [class A]
...
### 5-3 Wave Transmission (impermeable)  [class A]
...
### 5-4 Wave Transmission (permeable)  [class C]
...
### 6-1 Longshore Sediment Transport  [class A]
...
### 6-2 Time-Dependent Beach and Dune Erosion (Kriebel-Dean)  [class A]
...
### 6-4 Beach Nourishment / Overfill  [class A]
...
### 6-5 Composite (Native/Borrow) Grain Size  [class A]
...
### 7-1 Spatially Integrated Inlet Hydraulics  [class C]
...
### 7-2 Wave-Current Interaction  [class A]
...
### 8-1 Properties of Rectangular Basins  [class A]
...
### 8-2 Vessel-Generated Waves  [class A]
...
### 8-3 Moored Vessel Motions / Surge  [class A]
...
### 9-1 Bathystrophic Storm Surge  [class C]
...
### M-1 Miscellaneous Breaker and Steepness Routines  [class B]
